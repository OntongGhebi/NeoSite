  ...
  try {
    ...
    const codeGenerationResponse = await openai.chat.completions.create({
      ...
      messages: [
        ...
        - Use modern, beautiful design with great UX using Tailwind CSS classes
        - Make it responsive using Tailwind responsive classes (sm:, md:, lg:, xl:)
        - Use Tilwind animations and transitions (animate-*, transition-*)
      ...
      line_items: [
        {
          price_data: {
            currency: "usd",
            product_data: {
              name: `NeoSite Buileder - ${plan.credits} credits`,
            },
