        ...
        {loading ? (
          ...
          <div className="py-10 min-h-[80vh]">
            <div className="flex items-center justify-between mb-12">
              ...
              <button
                onClick={() => navigate("/")}
                className="flex items-center gap-2 text-white px-3 sm:px-6 py-1 sm:py-2
                    ...
                    >
                      ...
                      <div className="flex gap-3 text-white text-sm">
                        <button
                          ...
                          className="px-3 bg-white/10 hover:bg-white/15 rounded-md transition-all"
                        >
                          Preview
                        </button>
                        <button
                          onClick={() => navigate(`/projects/${project.id}`)}
                          className="px-3 py-0.5 bg-white/10 hover:bg-white/15 rounded-md transition-all"
                        >
                          Open
                        </button>
                      </div>
